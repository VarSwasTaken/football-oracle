...
export function GoalDistributionChart({ homeLambda, awayLambda, homeTeam, awayTeam }: GoalDistributionChartProps) {
  ...
  // Dopóki komponent się nie zamontuje, używamy bezpiecznych kolorów, żeby nie wywołać błędów hydracji
                ...
                <Tooltip
                  ...
                  content={({ active, payload, label }) => {
                    if (active && payload && payload.length) {
                      return (
                        <div className="rounded-lg border border-border/50 bg-popover/95 p-3 shadow-xl">
